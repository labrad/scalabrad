...
class LocalServerActor(
  server: LocalServer,
  hub: Hub,
  tracker: StatsTracker
)(implicit ec: ExecutionContext) extends ServerActor {
...
class MultiheadServer(name: String, registry: RegistryStore, server: LocalServer, externalConfig: ServerConfig)(implicit ec: ExecutionContext) extends Logging {
